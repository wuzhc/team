...
?>
    <div class="team-create">
        ...
        <div class="project-form box box-success">
            <form id="w0" action="<?= \yii\helpers\Url::to(['team/update', 'id' => $team->id]) ?>" method="post">
                ...
                <div class="box-body table-responsive">
                    ...
                    <div class="form-group field-project-fdname required">
                        ...
                        <input type="text" id="project-fdname" class="form-control" name="name" maxlength="32"
                               aria-required="true" value="<?= $team->fdName ?>">
                    ...
                    <div class="form-group field-project-fddescription">
                        ...
                        <textarea id="project-fddescription" class="form-control" name="desc" rows="10"
                                  cols="30" placeholder="随便写点什么吧"><?= $team->fdDescription ?></textarea>
                        ...
                        <?php if ($members) { ?>
                            <?php foreach ($members as $member) { ?>
                                <label class="checkbox-inline" style="margin-bottom: 20px">
                                    <input type="checkbox" id="inlineCheckbox1" value="<?= $member->id ?>"
                                           name="members[]" <?= $member->fdTeamID == $team->id ? 'checked="checked"' :
                                        '' ?>>
                                    <img src="<?= $member->fdPortrait ?: \common\config\Conf::USER_PORTRAIT ?>"
                                         alt="User Image" width="100px" height="100px"
                                         class="<?= $member->fdTeamID == $team->id ? 'img-circle' : 'img-thumbnail' ?>">
