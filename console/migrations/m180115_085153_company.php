...
class m180115_085153_company extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->batchInsert($this->tableName, ['fdName', 'fdCreatorID', 'fdDescription', 'fdStatus', 'fdCreate', 'fdUpdate'], [
            [
                '阿里巴巴',
                0,
            ...
            [
                '百度',
                0,
                '全球最大的中文搜索引擎、最大的中文网站。1999年底,身在美国硅谷的李彦宏看到了中国互联网及中文搜索引擎服务的巨大发展潜力，抱着技术改变世界的梦想，他毅然辞掉硅谷的高薪工作，携搜索引擎专利技术，于 2000年1月1日在中关村创建了百度公司。',
                1,
                date('Y-m-d H:i:s'),
                date('Y-m-d H:i:s')
            ],
            [
                '广州未名中智教育科技有限公司',
                0,
                '北大未名生物工程集团有限公司（简称：北大未名）是北京大学三大产业集团之一。广州未名中智教育科技有限公司是北大未名集团旗下专业教育科技公司。',
                1,
                date('Y-m-d H:i:s'),
                date('Y-m-d H:i:s')
            ],
